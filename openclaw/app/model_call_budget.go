...
const finalModelCallNotice = "[OpenClaw Budget Notice] This is the " +
	...
	"future tool use. Do not ask to continue. Put the answer in visible " +
	"assistant message content for the user, not only in internal reasoning " +
	"or thinking content. If evidence is incomplete, give the best " +
	"supported final answer now. If the original task requires a " +
	"final-answer format, follow it exactly."
